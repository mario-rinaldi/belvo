 ...
 * @extends Resource
 */
var TaxReturn = /*#__PURE__*/function (_Resource) {
  _inherits(TaxReturn, _Resource);

  var _super = _createSuper(TaxReturn);

  function TaxReturn() {
    var _this;

    _classCallCheck(this, TaxReturn);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/tax-returns/'
    });
    return _this;
  }

  _createClass(TaxReturn, [{
    key: "retrieve",
    value:
    /**
     * Retrieve tax returns information from a specific fiscal link.
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                token = options.token, saveData = options.saveData, attachPDF = options.attachPDF, type = options.type;
                data = {
                  link: link,
                  token: token,
                  save_data: saveData,
