 ...
 * @extends Resource
 */
var RecurringExpense = /*#__PURE__*/function (_Resource) {
  _inherits(RecurringExpense, _Resource);

  var _super = _createSuper(RecurringExpense);

  function RecurringExpense() {
    var _this;

    _classCallCheck(this, RecurringExpense);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/recurring-expenses/'
    });
    return _this;
  }

  _createClass(RecurringExpense, [{
    key: "retrieve",
    value: // eslint-disable-line no-use-before-define
