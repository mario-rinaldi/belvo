 ...
 * @extends Resource
 */
var RiskInsights = /*#__PURE__*/function (_Resource) {
  _inherits(RiskInsights, _Resource);

  var _super = _createSuper(RiskInsights);

  function RiskInsights() {
    var _this;

    _classCallCheck(this, RiskInsights);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/risk-insights/'
    });
    return _this;
  }

  _createClass(RiskInsights, [{
    key: "retrieve",
