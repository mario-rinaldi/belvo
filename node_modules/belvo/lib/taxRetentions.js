 ...
 * @extends Resource
 */
var TaxRetentions = /*#__PURE__*/function (_Resource) {
  _inherits(TaxRetentions, _Resource);

  var _super = _createSuper(TaxRetentions);

  function TaxRetentions() {
    var _this;

    _classCallCheck(this, TaxRetentions);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/tax-retentions/'
    });
    return _this;
  }

  _createClass(TaxRetentions, [{
    key: "retrieve",
    value:
    /**
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                saveData = options.saveData, attachXML = options.attachXML;
                data = {
                  link: link,
                  date_from: dateFrom,
                  date_to: dateTo,
