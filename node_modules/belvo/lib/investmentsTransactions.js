 ...
 * @extends Resource
 */
var InvestmentsTransaction = /*#__PURE__*/function (_Resource) {
  _inherits(InvestmentsTransaction, _Resource);

  var _super = _createSuper(InvestmentsTransaction);

  function InvestmentsTransaction() {
    var _this;

    _classCallCheck(this, InvestmentsTransaction);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'investments/transactions/'
    });
    return _this;
  }

  _createClass(InvestmentsTransaction, [{
    key: "retrieve",
    value:
    /**
...
var _default = InvestmentsTransaction;
